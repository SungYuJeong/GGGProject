...
body .container .half.bg {
  background-image: url("https://scontent.cdninstagram.com/vp/4763af3b39ff8cd391202beba485b021/5D7B7A54/t51.2885-15/sh0.08/e35/s640x640/57623867_1720378251748736_7641799765641324208_n.jpg?_nc_ht=scontent.cdninstagram.com");
...
<section class="container">
		    <article class="half">
			        <p>G<sub>a</sub> G<sub>u</sub> G<sub>roup</sub></p>
			        <div class="tabs">
			        ...
			        <div class="content">
				            <div class="signin-cont cont">
					                <form action="login.do" name="form" method="post">
						                    <input type="text" name="id" id="text" class="inpt" required="required" placeholder="Your ID">
